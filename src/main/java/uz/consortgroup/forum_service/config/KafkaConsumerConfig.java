...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> universalConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "uz.consortgroup.forum_service.event");

        props.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, true);

        props.put(JsonSerializer.TYPE_MAPPINGS, "course-group:uz.consortgroup.forum_service.event.course_group.CourseGroupOpenedEvent");
